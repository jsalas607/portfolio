// Datos del perfil (bilingüe). Editá acá y se actualiza todo el sitio.
...
export const profile: Record<Lang, Profile> = {
  ...
  en: {
    ...
    role: "Full Stack Developer",
    tagline:
      "I build web and mobile applications end to end, focused on fast, accessible and well-crafted experiences.",
    location: "Bogotá, Colombia",
    available: true,
    email: "jsalasparra607@gmail.com",
    github: "https://github.com/jsalas607",
    ...
    photo: "/foto.png",
    bio: [
      "I'm a full-stack developer based in Bogotá. I build complete projects end to end: a restaurant management system with a backend, database and mobile app, a web game built with React, and a party-game app in Flutter.",
      "I'm comfortable on both sides of the stack. On the frontend I work with React, Next.js and Tailwind; on the backend with Python, FastAPI and SQL, including real-time features with WebSockets and database migrations.",
      "I've worked as a freelancer on several projects, building APIs, admin dashboards and tailored solutions for clients across different industries. I enjoy solving real problems, learning constantly and shipping clean, quality code.",
    ],
    learning: ["Advanced TypeScript", "Testing (Vitest / Playwright)", "Architecture & patterns", "Docker in production"],
  },
};
