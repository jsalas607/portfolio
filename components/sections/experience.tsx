import { experiencia } from "@/data/stack";
    ...
    <section id="experiencia" className="mx-auto max-w-5xl scroll-mt-20 px-6 py-24">
      ...
      <ol className="relative border-l border-border">
        {experiencia.map((item, i) => (
          <li key={item.titulo} className="relative mb-10 pl-6 last:mb-0">
            ...
            <Reveal delay={i * 0.08}>
              <div className="flex flex-wrap items-baseline justify-between gap-2">
                ...
                <span className="font-mono text-xs text-subtle">{item.periodo}</span>
              </div>
